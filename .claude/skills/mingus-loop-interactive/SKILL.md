...
5. **Autosave.** `/hachiko-autosave ... --event=checkin-created`.
6. **Checkpoint.** Free mode: after every deliverable. Sequential mode:
   after every deliverable **or** when the human explicitly asks.
   Invoke `/hachiko-pull-request <slug> <branch>`.

### Step 3. Phase close

- All deliverables accounted for.
- Full verification passes.
- `/hachiko-pull-request` is fresh.
- `/hachiko-autosave --event=phase-completed --detail=<N>
...
1. `/hachiko-pr-respond <slug> <pr>` → plan.
