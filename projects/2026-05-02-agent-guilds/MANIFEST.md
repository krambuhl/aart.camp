...
**Started**: 2026-05-02
**Status**: active
**Current branch**: ev.agent-guilds.domain-pairs-2
**Latest checkin**: checkins/ev.agent-guilds.domain-pairs-2/01.md
...
| 4 | Domain pairs | in-progress | ev.agent-guilds.domain-pairs-2 | 01 | #71 (merged) |
