          ...
          for (let i = 0; i < length; i++) {
            ...
            p.circle(
              Math.sin(input) * (size / 6) +
                Math.cos(offset) *
                  (size /
                    p.lerp(6, p.lerp(5, 12, Math.cos(pos)), (Math.cos((offset * i) / 40) * Math.tan((i * offset) / 60)) / p.lerp(2, 4, Math.sin(input / 30)))),
              Math.cos(input) * (size / 6) +
                Math.sin(offset) *
                  (size /
                    p.lerp(6, p.lerp(5, 14, Math.sin(pos)), (Math.sin((offset * i) / 40) * Math.tan((i * offset) / 60)) / p.lerp(2, 4, Math.sin(input / 30)))) +
                pos * 36,
