      ...
      <Sketch
        ...
        draw={(p, store) => {
          ...
          for (let i = 0; i < frameLength; i++) {
            ...
            const res =
              ((time + x * currentTurnCount + time * 0.111 * currentTurnCount + currentSnakeLength + (bandSize - bandCount) * currentTurnCount) * offset) %
              rainbow.length;
